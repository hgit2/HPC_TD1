...
legend("topleft", c("Somme de 2 vecteurs", "Produit des éléments de 2 vecteurs","Somme des éléments d'un vecteur"), col=c("darkorange1","brown", "darkcyan"), lty=c(1,1,1), pch=c(4,17,19))
...
plot( fort_prod_t3$nb.coeurs, fort_prod_t3$moy, type = "b", pch=15, col="darkgoldenrod4", main = "Temps d'exécution en fonction du nombre de coeurs pour un passage à l'échelle forte (Produit des éléments de 2 vecteurs)", xlab="Nombre de coeurs", ylab="Temps d'exécution moyen", ylim=c(2,600))
...
#plot
plot( fort_sum2_t3$nb_coeur, fort_sum2_t3$moy, type = "b", pch=7, col="darkgoldenrod4", main = "Temps d'exécution en fonction du nombre de coeurs pour un passage à l'échelle forte (Somme de 2 vecteurs)", xlab="Nombre de coeurs", ylab="Temps d'exécution moyen", ylim = c(0,800))
...
legend("topleft", c("Produit des éléments de 2 vecteurs","Somme des éléments d'un vecteur", "Somme de 2 vecteurs"), col=c("brown", "darkcyan", "darkorange1"), lty=c(1,1,1), pch=c(17,19,4))
